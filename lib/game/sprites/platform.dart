...
enum PlataformaInvertidaState {invertida, noinvertida }

class PlataformaInvertida extends Platform<PlataformaInvertidaState> {
  PlataformaInvertida({super.position});

  @override
  Future<void>? onLoad() async {
    await super.onLoad();

    sprites = <PlataformaInvertidaState, Sprite>{
      PlataformaInvertidaState.invertida:
          await gameRef.loadSprite('game/plataforma_invertida.png'),
      PlataformaInvertidaState.noinvertida:
          await gameRef.loadSprite('game/plataforma_no_invertida.png'),
    };

    current = PlataformaInvertidaState.invertida;
    size = Vector2(115, 84);
  }

  void desinvertirPlataforma() {
    current = PlataformaInvertidaState.noinvertida;
  }
}
