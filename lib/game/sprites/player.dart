  ...
  void onCollision(Set<Vector2> intersectionPoints, PositionComponent other) {
    ...
    if (isMovingDown && isCollidingVertically) {
      ...
      if (other is NormalPlatform) {
        ...
        other.breakPlatform();
        return;
      } else if (other is PlataformaInvertida &&
          other.current == PlataformaInvertidaState.invertida) {
        jump(specialJumpSpeed: jumpSpeed * -1);
        other.desinvertirPlataforma();
        return;
      }
    }
    ...
    if (!hasPowerup && other is Rocket) {
      ...
      jump(specialJumpSpeed: jumpSpeed * other.jumpSpeedMultiplier);
      return;
    }else if (!hasPowerup && other is Star){
      other.removeFromParent();
      jump(specialJumpSpeed: jumpSpeed * other.jumpSpeedMultiplier);
      return;
    }
